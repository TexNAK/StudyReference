...
\begin{document}
    ...
    \section{Darstellung von Informationen}
        ...
        \subsection{Audioaufnahmen}
            Für Audioaufnahmen werden mithilfe einer in ein Mikrofon eingebauten Membran Elongationen der Schallwellen gemessen, die mit einem Analog-Digital-Wandler in für den Computer auswertbare Daten konvertiert. Die so gemessenen Elongationen werden hintereinander in der Audiodatei gespeichert.
            
            Um die Qualität der Audiodatei zu beeinflussen gibt es zwei Faktoren. Zum einen die Auflösung des A-D-Wandlers und damit die Auflösung der digitalisierten Elongation. Heute wird hier typischerweise \emph{8 Bit} verwendet. Zum anderen kann die zeitliche Auflösung, also die Anzahl der Messungen pro Zeiteinheit, verändert werden. Heute werden hier zum Beispiel \emph{44100 Messpunkte je Sekunde} gemessen.
        ...
        \subsection{Rationale Zahlen}
            ...
            \subsubsection{Floatkommazahlen}
